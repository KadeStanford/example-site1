              ...
              <div id="milknote">
                <div id="stroop">
                  <div id="coffeeflavors">
                    Coffee Flavors:<br></br>Mocha, Vanilla (regular or
                    sugar-free), Caramel, White Chocolate
                  </div>
                </div>
                <br></br>
                <div id="icednote">
        ...
        <div className="image-container">
          ...
          <div className="menu-content">
            ...
            <div id="menubiscuit">
              ...
              <li id="fixings">
                Add Preserves (Strawberry or Blackberry) ...0.59<br></br>Add
                Deer Sausage Patty ...1.99<br></br>Add Egg Bite* ...3.69
              </li>
            </div>
          </div>
        </div>
          ...
          <div className="menu-content">
            ...
            <div id="menubagel">
              ...
              <li id="fixings2">
                ...
                (Strawberry or Blackberry) ...0.59<br></br>Add Deer Sausage
                Patty ...1.99<br></br>Add Cream Cheese ...0.99<br></br>Add Egg
                Bite* ...3.69
              </li>
            </div>
          </div>
