    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          visibility:
            currentPage == "" || currentPage === "menu" ? "visible" : "hidden",
            ...
            <div id="menustroop">
              ...
              <div id="stroopnote">
                *Stroopwafel hails from the Netherlands. It is a crispy,
                buttery, caramel-filled, thin waffle cookie. <br></br>Set it on
                top of your hot coffee and enjoy what happens next!
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="image-container">
          ...
          <div className="menu-content">
            ...
            <div id="menubiscuit">
              {" "}
              <li id="biscuitprice">
                <div id="biscuitprice1">Large Buttermilk Biscuit w/ Butter</div>
                <div id="biscuitprice2">...2.59</div>
              </li>{" "}
              <li id="fixings">
                Add Preserves (Strawberry, Blackberry, Organic, Reduced Sugar
                Cherry Blueberry) ...0.59<br></br>Add Deer Sausage Patty ...1.99
          ...
          <div className="menu-content">
            ...
            <div id="menubagel">
              ...
              <li id="fixings2">
                ...
                <br></br>Add Cream Cheese ...0.99<br></br>Add Egg Bite* ...3.69
              </li>
            </div>
          </div>
        </div>
          ...
          <div className="event-content">
            ...
            <div id="menuicecream">
              ...
              <div id="icecreamtext">
                ...
                gourmet cookies with special flavors for the kids, or the kid in
                you!
                <br></br>Mix and match our <div id="chilly">chilly treats!</div>{" "}
              </div>
            </div>{" "}
          </div>
        </div>
