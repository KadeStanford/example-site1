...
export default function Home() {
  ...
  <div className="image-container">
    ...
    <div id="menucoffeeheader">Liberty House Special Brew</div><div id="menucoffee">
        ...
        <ul className="subsixcold">(16oz.) <br></br> ...4.45</ul>
        </li>
...
<div className="image-container">
    ...
    <div id="croissantheader">Croissants</div>
        ...
        <li id="ham">
        <div id="croissantflavor">Ham and Swiss</div><div id="cp2">...5.95</div></li>
        <li id="spinach">
        <div id="croissantflavor">Spinach and Feta</div><div id="cp5">...5.95</div></li>
        <li id="almond">
        <div id="croissantflavor">Almond</div><div id="cp3">...3.95</div></li>
        <li id="chocolate">
        <div id="croissantflavor">Chocolate</div><div id="cp4">...3.75</div></li>
       </div>
       </div> 
    </div>
    </div>
    ...
    <div id="scones">Scones</div>
      <div id="menuscone">
      <li id="sconeprice"><div id="blueberry">Blueberry</div><div id="bp">...3.89</div></li>
      </div>
    </div>
    </div>  
    ...
    <div className="image-container">
      ...
      <div id="menubrownsugarcake"> <li id="cakeprice"><div id="slice">Per Slice</div><div id="sliceprice">...3.59</div></li> </div>
 ...
 <div className="image-container">
      ...
      <div id="menuraspberrydanish"> <li id="raspberrydanishprice"><div id="sliceraspberry">Per Muffin</div><div id="slicepriceraspberry">...3.39</div></li> </div>

          </div>
          </div>

 <div className="image-container">
          <img  id="raspberrydanishimage" src="/images/cookie.png" alt="cookie"></img>
          <div className="menu-content">
            
      <div id="raspberrydanishheader">Extra Lg. Choc Chunk Cookie</div>
      <div id="menuraspberrydanish"> <li id="raspberrydanishprice"><div id="sliceraspberry">Per Cookie</div><div id="slicepriceraspberry">...3.69</div></li> </div>
      ...
      <div id="menubiscuit"> <li id="biscuitprice"><div id="biscuitprice1">Large Buttermilk Biscuit w/ Butter</div><div id="biscuitprice2">...2.59</div></li> <li id="fixings">Add Preserves (Strawberry or Blackberry) ...0.59<br></br>Add Deer Sausage Patty ...1.99<br></br>Add Egg Bite* ...3.69</li></div>
      ...
      <div id="menubagel"> <li id="bagelprice"><div id="bagelprice1">Plain Bagel w/ Butter<br></br></div><div id="bagelprice2">...2.69</div></li> <li id="fixings2">(Substitute Cinnamon Butter  ...0.30) <br></br>Add Preserves (Strawberry or Blackberry) ...0.59<br></br>Add Deer Sausage Patty ...1.99<br></br>Add Cream Cheese ...0.99<br></br>Add Egg Bite* ...3.69</li></div>
      ...
      <div id="menuegg"> <li id="eggprice"><div id="eggprice1">Egg Bite* (2 per order)</div><div id="eggprice2">...6.59</div></li> <li id="eggfixings">*Options: 1. Ham and Cheddar Chili Pepper,
